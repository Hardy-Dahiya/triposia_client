                ...
                <div className="single-blog-details">
                  <div className="single-blog-details-content pt-0">
                    <h2 className="single-blog-details-content-title fw-500">
                      {' '}
                      Do they have any other concerns or needs that we should keep in mind during
                      the demo today?{' '}
                    </h2>
                    <div className="single-blog-details-content-tags mt-3">
                      ...
                      <span className="single-blog-details-content-tags-item"> 28 Jun 2022 </span>
                    </div>
                    <div className="single-blog-details-content-tags mt-3">
                      <span className="single-blog-details-content-tags-item">
                        {' '}
                        <a href="javascript:void(0)">Author: Pardeep Kumar</a>{' '}
                      </span>
                    </div>
                    <div className="single-blog-details-thumb mt-4">
                      <img className="radius-5" src="images/blog_details.jpg" alt="" />
                    </div>
                    <p className="single-blog-details-content-para mt-4">
                      {' '}
                      Mutley, you snickering, floppy eared hound. When courage is needed, you’re
                      never around. Those medals you wear on your moth-eaten chest should be there
                      for bungling at which you are best. So, stop that pigeon, stop that pigeon,
                      stop that pigeon, stop that pigeon, stop that pigeon, stop that pigeon, stop
                      that pigeon. Howwww! Nab him, jab him, tab him, grab him, stop that pigeon
                      now.{' '}
                    </p>
                    <p className="single-blog-details-content-para mt-4">
                      {' '}
                      ...
                      Sharing everything with fun, that’s the way to be. One for all and all for
                      one, Muskehounds are always ready. One for all and all for one, helping
                      everybody. One for all and all for one, can sound pretty corny. If you’ve got
                      a problem chum, think how it could be.{' '}
                    </p>
                    <blockquote className="section-bg-1 mt-4">
                      <div className="blockquote-contents">
                        <h3 className="blockquote-contents-title color-heading fw-500">
                          {' '}
                          What do you currently do to manage? Do you feel that is getting the
                          results you want?”{' '}
                        </h3>
                      </div>
                    </blockquote>
                    ...
                    <div className="blog-details-advertise center-text mt-4">
                      <a href="javascript:void(0)">
                        {' '}
                        <img className="radius-5" src="images/advertise.jpg" alt="" />{' '}
                      </a>
                    </div>
                    <p className="single-blog-details-content-para mt-4">
                      {' '}
                      Dolor sit amet, consectetur adipiscing elit. Semper cras elementum sit risus
                      ornare ac. Sed donec malesuada elit vitae mollis cras quam. Ut risus euismod
                      etiam vel imperdiet pellentesque. Tristique neque lacinia non interdum. Amet
                      orci, neque, mauris, amet mattis ultrices iaculis eget lacus. Mi placerat
                      sagittis malesuada enim etiam at tellus. Sed et vitae enim nam a lacinia
                      tristique nunc. Ac posuere enim faucibus quis id tellus rutrum sed proin.
                      Faucibus turpis in scelerisque elementum mauris vestibulum.{' '}
                    </p>
                    <p className="single-blog-details-content-para mt-4">
                      {' '}
                      Sed donec malesuada elit vitae mollis cras quam. Ut risus euismod etiam vel
                      imperdiet pellentesque. Tristique neque lacinia non interdum. Amet orci,
                      neque, mauris, amet mattis ultrices iaculis eget lacus. Mi placerat sagittis
                      malesuada enim etiam at tellus. Sed et vitae enim nam a lacinia tristique
                      nunc. Ac posuere enim faucibus quis id tellus rutrum sed proin. Faucibus
                      turpis in scelerisque elementum mauris vestibulum.{' '}
                    </p>
                  </div>
                </div>
